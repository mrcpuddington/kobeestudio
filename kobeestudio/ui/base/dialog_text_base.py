# Portions derived from KiBuzzard.
# Copyright (c) 2020 Greg Davill <greg.davill@gmail.com>
# Modifications Copyright (c) 2026 Corey Busuttil <hello@coreybusuttil.com>
# The original KiBuzzard MIT permission notice is retained in
# kobeestudio/vendor/licenses/kiBuzzard-LICENSE. Distributed as part of
# Kobee Studio under GPL-2.0-only.
...
class DIALOG_TEXT_BASE ( DialogShim ):
    ...
    def __init__( self, parent ):
        DialogShim.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Kobee Studio"), pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.SYSTEM_MENU )
