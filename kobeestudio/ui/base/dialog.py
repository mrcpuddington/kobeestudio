...
class Dialog(dialog_text_base.DIALOG_TEXT_BASE):
    ...
    config_defaults = {
        ...
        'PaddingTopCtrl': '0.2',
        'PaddingLeftCtrl': '0.4',
        'PaddingRightCtrl': '0.4',
        'PaddingBottomCtrl': '0.2',
        'LineSpacingCtrl': '1.5',
        'WidthCtrl': None,
    ...
    def loadConfig(self):
            ...
            if len(selected_footprints) == 1:
                ...
                if (
                    ...
                    if param_str.startswith("kb_params="):
                        ...
                        # New footprints embed a versioned composition document
        ...
        params = dict(self.config_defaults)
        try:
    ...
    def ReGeneratePreview(self, e=None):
        ...
        # Kobee Studio aims to size uppercase letters at the height requested.
