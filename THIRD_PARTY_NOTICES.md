...
Kobee Studio is a substantial evolution of **KiBuzzard**, originally created by
Greg Davill. The font-to-vector renderer and base dialog began in that project;
their source provenance is retained in comments and commit history.
